...
public class LGCompoLoupsGui implements GuiBuilder {
    public String name() {
        return "§cComposition des Loups";
    }
    ...
    public void contents(Player player, Inventory inv) {
        ...
        for (LGRolesEnum lgRolesEnum : lguhc.getRolesManager().getCompoForSide(LGSides.LGBasicSides.LOUPS).keySet().stream().sorted().collect(Collectors.toList())) {
